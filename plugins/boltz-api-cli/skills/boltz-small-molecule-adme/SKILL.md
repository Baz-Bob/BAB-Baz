...
description: "用 Boltz 从裸 SMILES 预测小分子的一级 ADME/ADMET——无需靶点、无需对接。适用于用户想要某个或某组分子的溶解度、渗透性或亲脂性/logD 的场景。不适用于将分子针对蛋白质靶点排序（请用 boltz-small-molecule-screen，它已免费返回 ADME）。"
---
