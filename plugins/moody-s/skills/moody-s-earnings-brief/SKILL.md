...
description: "使用 Moody's GenAI MCP 工具，为 2–5 家公司生成财报电话会议摘要 HTML 报告。当用户要求汇总财报电话会议、生成财报电话会议摘要、跨同业分析财报记录，或创建财报电话会议报告时使用本技能。即使只是点名公司并提到「earnings」或「transcript」也应触发。"
---
